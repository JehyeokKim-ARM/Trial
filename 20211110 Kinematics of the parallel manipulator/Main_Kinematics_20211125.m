...
syms theta 
        ...
        RRmp_1 = rmp_1 + [d4*cos(pi+gamma1); 0; d4*sin(pi+gamma1);];
        RRmp_2 = rmp_2;
        RRmp_3 = rmp_3;
...
%moving platform 
plot3([RQ_mp_2t(1),RQ_mp_1t(1)], [RQ_mp_2t(2),RQ_mp_1t(2)], [RQ_mp_2t(3),RQ_mp_1t(3)], 'k','Linewidth',1)
plot3([RQ_mp_2t(1),RQ_mp_3t(1)], [RQ_mp_2t(2),RQ_mp_3t(2)], [RQ_mp_2t(3),RQ_mp_3t(3)], 'k','Linewidth',1)
plot3([RQ_mp_3t(1),RQ_mp_1t(1)], [RQ_mp_3t(2),RQ_mp_1t(2)], [RQ_mp_3t(3),RQ_mp_1t(3)], 'k','Linewidth',1)

plot3([Q_mp_1t(1),RQ_mp_1t(1)], [Q_mp_1t(2),RQ_mp_1t(2)], [Q_mp_1t(3),RQ_mp_1t(3)], 'm','Linewidth',2)
plot3([Q_mp_2t(1),RQ_mp_2t(1)], [Q_mp_2t(2),RQ_mp_2t(2)], [Q_mp_2t(3),RQ_mp_2t(3)], 'm','Linewidth',2)
...
for i = 1 : 1 : (160/10)+1
WorkpointY(i) = -0.8 + 0.1*(i-1);
WorkpointZ(i) = -0.8 + 0.1*(i-1);
end
for i = 1 : 1 : (160/10)+1
    for j = 1 : 1 : (160/10)+1
        for k = 1 : 1 : 9
            plot3((k-1)*0.1,WorkpointY(i),WorkpointZ(j),'co');
        end
    end
end

%% x = 0 Inverse kinematic for work point candidates 
for i = 1 : 1 : 17
    i
    for j = 1 : 1 : 17
        omega_mp = [0;0;0];
        v = [0;WorkpointY(i);WorkpointZ(j)];
        S_mp = [omega_mp;-cross(omega_mp,v);];
...
for i = 1 : 1 : (160/10)+1
    for j = 1 : 1 : (160/10)+1
            if IKC(i,j) == 0
                figure(2)
            plot3(0,WorkpointY(i),WorkpointZ(j),'ro');
            else
                figure(2)
            plot3(0,WorkpointY(i),WorkpointZ(j),'co');    
            hold on
            end
...
for i = 1 : 1 : (160/10)+1
    for j = 1 : 1 : (160/10)+1
            if IKC1(i,j) == 0
                figure(2)
            plot3(0.1,WorkpointY(i),WorkpointZ(j),'ro');
            else
                figure(2)
            plot3(0.1,WorkpointY(i),WorkpointZ(j),'co');    
            hold on
            end
...
for i = 1 : 1 : (160/10)+1
    for j = 1 : 1 : (160/10)+1
            if IKC2(i,j) == 0
                figure(2)
            plot3(0.2,WorkpointY(i),WorkpointZ(j),'ro');
            else
                figure(2)
            plot3(0.2,WorkpointY(i),WorkpointZ(j),'co');    
            hold on
            end
...
for i = 1 : 1 : (160/10)+1
    for j = 1 : 1 : (160/10)+1
            if IKC3(i,j) == 0
                figure(2)
            plot3(0.3,WorkpointY(i),WorkpointZ(j),'ro');
            else
                figure(2)
            plot3(0.3,WorkpointY(i),WorkpointZ(j),'co');    
            hold on
            end
...
for i = 1 : 1 : (160/10)+1
    for j = 1 : 1 : (160/10)+1
            if IKC4(i,j) == 0
                figure(2)
            plot3(0.4,WorkpointY(i),WorkpointZ(j),'ro');
            else
                figure(2)
            plot3(0.4,WorkpointY(i),WorkpointZ(j),'co');    
            hold on
            end
...
for i = 1 : 1 : (160/10)+1
    for j = 1 : 1 : (160/10)+1
            if IKC5(i,j) == 0
                figure(2)
            plot3(0.5,WorkpointY(i),WorkpointZ(j),'ro');
            else
                figure(2)
            plot3(0.5,WorkpointY(i),WorkpointZ(j),'co');    
            hold on
            end
...
VV = VideoWriter('Workspacetest_0.4');
open(VV)
figure(1)
...
for i = 1 : 1 : 17
    for j = 1 : 1 : 17
if IKC4(i,j) == 0
Q1_1t = Q1_1(angle1_1(i,j),angle1_2(i,j),angle1_3(i,j));
Q1_2t = Q1_2(angle1_1(i,j),angle1_2(i,j),angle1_3(i,j));
Q1_3t = Q1_3(angle1_1(i,j),angle1_2(i,j),angle1_3(i,j));
Q1_st = Q1_s(angle1_1(i,j),angle1_2(i,j),angle1_3(i,j));

Q2_1t = Q2_1(angle2_1(i,j),angle2_2(i,j),angle2_3(i,j));
Q2_2t = Q2_2(angle2_1(i,j),angle2_2(i,j),angle2_3(i,j));
Q2_3t = Q2_3(angle2_1(i,j),angle2_2(i,j),angle2_3(i,j));
Q2_st = Q2_s(angle2_1(i,j),angle2_2(i,j),angle2_3(i,j));

Q3_1t = Q3_1(angle3_1(i,j),angle3_2(i,j),angle3_3(i,j));
Q3_2t = Q3_2(angle3_1(i,j),angle3_2(i,j),angle3_3(i,j));
Q3_3t = Q3_3(angle3_1(i,j),angle3_2(i,j),angle3_3(i,j));
Q3_st = Q3_s(angle3_1(i,j),angle3_2(i,j),angle3_3(i,j));
...
%moving platform 
plot3([MPrjoint1X(i,j),MPrjoint2X(i,j)], [MPrjoint1Y(i,j),MPrjoint2Y(i,j)], [MPrjoint1Z(i,j),MPrjoint2Z(i,j)], 'k','Linewidth',1)
plot3([MPrjoint3X(i,j),MPrjoint2X(i,j)], [MPrjoint3Y(i,j),MPrjoint2Y(i,j)], [MPrjoint3Z(i,j),MPrjoint2Z(i,j)], 'k','Linewidth',1)
plot3([MPrjoint3X(i,j),MPrjoint1X(i,j)], [MPrjoint3Y(i,j),MPrjoint1Y(i,j)], [MPrjoint3Z(i,j),MPrjoint1Z(i,j)], 'k','Linewidth',1)

plot3([MPsjoint2X(i,j),MPrjoint2X(i,j)], [MPsjoint2Y(i,j),MPrjoint2Y(i,j)], [MPsjoint2Z(i,j),MPrjoint2Z(i,j)], 'k','Linewidth',1)
plot3([MPrjoint3X(i,j),MPsjoint3X(i,j)], [MPrjoint3Y(i,j),MPsjoint3Y(i,j)], [MPrjoint3Z(i,j),MPsjoint3Z(i,j)], 'k','Linewidth',1)
plot3([MPsjoint1X(i,j),MPrjoint1X(i,j)], [MPsjoint1Y(i,j),MPrjoint1Y(i,j)], [MPsjoint1Z(i,j),MPrjoint1Z(i,j)], 'k','Linewidth',1)
